...
\usepackage{hyperref}
\usepackage{setspace}
\usepackage{mdframed} % For creating the outer border
...
% Outer border for the entire content
\begin{mdframed}[linewidth=2pt, roundcorner=10pt, nobreak=true]

% Header
\begin{center}
    {\Large \textbf{Lab Notebook Entries}} \\
    \vspace{0.3cm} % Reduced space
    \textit{Entry by Sourav Kundu} \\
    \vspace{0.2cm}
    Date: \textit{[September 12, 2024]} \\
